...
下载nginx-1.10.1 zip 安装包
[download](http://nginx.org/download/nginx-1.10.1.zip)

下载RunHiddenConsole 安装包
[download](http://redmine.lighttpd.net/attachments/660/RunHiddenConsole.zip)
